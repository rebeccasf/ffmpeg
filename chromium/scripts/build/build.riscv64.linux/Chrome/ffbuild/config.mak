...
INSTALL_NAME_DIR=
SRC_PATH=/build/sw_buildbot/workspace/nwjs-src-thloh-wip/src/third_party/ffmpeg
SRC_LINK=/build/sw_buildbot/workspace/nwjs-src-thloh-wip/src/third_party/ffmpeg
ifndef MAIN_MAKEFILE
SRC_PATH:=$(SRC_PATH:.%=..%)
endif
CC_IDENT=clang version 15.0.0 (https://github.com/llvm/llvm-project/ 8133778d3c8d481891143e21e0c5081a02a9889d)
ARCH=riscv
INTRINSICS=none
EXTERN_PREFIX=
CC=clang
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/build/sw_buildbot/workspace/nwjs-src-thloh/src/build/linux/debian_sid_riscv64-sysroot/ -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -DPIC
CFLAGS=  -I/build/sw_buildbot/workspace/nwjs-src-thloh-wip/src/third_party/opus/src/include --target=riscv64-linux-gnu -mno-relax -mabi=lp64d -std=c11 -fomit-frame-pointer -fPIC -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCCFLAGS=  
ASFLAGS=  -I/build/sw_buildbot/workspace/nwjs-src-thloh-wip/src/third_party/opus/src/include --target=riscv64-linux-gnu -mno-relax -mabi=lp64d -fPIC -Qunused-arguments
NVCCFLAGS=--cuda-gpu-arch=sm_30 -O2 -std=c++11 -m32 -S -nocudalib -nocudainc --cuda-device-only -Wno-c++11-narrowing -include /build/sw_buildbot/workspace/nwjs-src-thloh-wip/src/third_party/ffmpeg/compat/cuda/cuda_runtime.h
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS= --target=riscv64-linux-gnu -L/usr/riscv64-linux-gnu/lib/ -mno-relax -fuse-ld=ld  --sysroot=/build/sw_buildbot/workspace/nwjs-src-thloh/src/build/linux/debian_sid_riscv64-sysroot/ -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=:libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
...
!CONFIG_IPFS_PROTOCOL=yes
!CONFIG_IPNS_PROTOCOL=yes
