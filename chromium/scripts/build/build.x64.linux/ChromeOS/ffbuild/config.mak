...
CFLAGS=  -I/build/sw_buildbot/workspace/nwjs-src-thloh-wip/src/third_party/opus/src/include -std=c11 -fomit-frame-pointer -fPIC -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -fno-math-errno -fno-signed-zeros -flto -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCCFLAGS=  
ASFLAGS=  -I/build/sw_buildbot/workspace/nwjs-src-thloh-wip/src/third_party/opus/src/include -fPIC -Qunused-arguments
NVCCFLAGS=--cuda-gpu-arch=sm_30 -O2 -std=c++11 -m64 -S -nocudalib -nocudainc --cuda-device-only -Wno-c++11-narrowing -include /build/sw_buildbot/workspace/nwjs-src-thloh-wip/src/third_party/ffmpeg/compat/cuda/cuda_runtime.h
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS= -fuse-ld=ld  -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=:libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil -fno-math-errno -fno-signed-zeros
LDEXEFLAGS=
LDSOFLAGS=
SHFLAGS=-shared -Wl,-soname,$$(@F) -Wl,-Bsymbolic -Wl,--version-script,$(SUBDIR)lib$(NAME).ver
ASMSTRIPFLAGS= -x
X86ASMFLAGS=-f elf64 -DPIC
MSAFLAGS=
MMIFLAGS=
LSXFLAGS=
LASXFLAGS=
