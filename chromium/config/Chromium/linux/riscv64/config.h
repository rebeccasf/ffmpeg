...
/* #define FFMPEG_CONFIGURATION "--disable-everything --disable-all --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-static --enable-avcodec --enable-avformat --enable-avutil --enable-fft --enable-rdft --enable-static --enable-libopus --disable-debug --disable-bzlib --disable-error-resilience --disable-iconv --disable-network --disable-schannel --disable-sdl2 --disable-symver --disable-xlib --disable-zlib --disable-securetransport --disable-faan --disable-alsa --disable-autodetect --enable-decoder='vorbis,libopus,flac' --enable-decoder='pcm_u8,pcm_s16le,pcm_s24le,pcm_s32le,pcm_f32le,mp3' --enable-decoder='pcm_s16be,pcm_s24be,pcm_mulaw,pcm_alaw' --enable-demuxer='ogg,matroska,wav,flac,mp3,mov' --enable-parser='opus,vorbis,flac,mpegaudio,vp9' --extra-cflags=-I/build/workspace/nwjs_src/src/third_party/opus/src/include --disable-linux-perf --x86asmexe=nasm --optflags='\"-O2\"' --enable-decoder='theora,vp8' --enable-parser='vp3,vp8' --arch=riscv --enable-cross-compile --target-os=linux --sysroot=/build/workspace/nwjs_src/src/build/linux/debian_sid_riscv64-sysroot --extra-cflags='--target=riscv64-linux-gnu' --extra-cflags=-mno-relax --extra-cflags='-mabi=lp64d' --extra-ldflags='--target=riscv64-linux-gnu' --extra-ldflags=-mno-relax --extra-ldflags=-L/usr/riscv64-linux-gnu/lib --enable-pic --cc=/build/workspace/nwjs_src/src/third_party/llvm-build/Release+Asserts/bin/clang --cxx=/build/workspace/nwjs_src/src/third_party/llvm-build/Release+Asserts/bin/clang++ --ld=/build/workspace/nwjs_src/src/third_party/llvm-build/Release+Asserts/bin/clang --extra-ldflags='-fuse-ld=ld'" -- elide long configuration string from binary */
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2022
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "clang version 15.0.0 (https://github.com/llvm/llvm-project/ ba4537b22796a561dbcd7cd4e666bb5039510b21)"
